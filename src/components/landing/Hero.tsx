...
export function Hero() {
  ...
  return (
    <section
      ref={rootRef}
      className="relative overflow-hidden px-6 pb-20 pt-36 sm:pt-44"
    >
      <HeroCanvas />
      <HeroChips />

      <div className="relative z-[2] mx-auto grid w-full max-w-5xl grid-cols-1 items-center gap-16 lg:grid-cols-2">
        <div className="flex flex-col items-start text-left">
          ...
          <h1
            data-hero-in
            className="mt-6 font-display text-[clamp(52px,8vw,104px)] font-bold leading-[0.95] tracking-tight text-text"
          >
            FLOAT
          </h1>

          <p data-hero-in className="mt-5 font-body text-[19px] font-medium text-text">
        ...
        <div data-hero-in className="flex justify-center lg:justify-end">
          <HeroDemo />
        </div>
      </div>
    </section>
